...
export ZEPPELIN_LOG_DIR={{ spark_zeppelin_log_dir }}  # Where log files are stored.  PWD by default.
export ZEPPELIN_PID_DIR={{ spark_zeppelin_run_dir }} # The pid files are stored. /tmp by default.
