...
#
#============================================================================
# While this module is available in Ansible 1.9.4 it does not support
# the cache_subnet_group which is required when creating Elasticache instances
# in a VPC. This option is only available in Ansible 2.0.
# As we currently use Ansible 1.9.4 the new version of the module had to be
