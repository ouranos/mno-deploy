...
#====================================================
# Setup deploy-aws-ubuntu-ci directory
rm -rf deploy-aws-ubuntu-ci
mkdir deploy-aws-ubuntu-ci

# Copy core deployment scripts
cp -R ../ansible deploy-aws-ubuntu-ci/
cp -R ../scripts deploy-aws-ubuntu-ci/

# Apply environment specific configuration
cp -R ci_environments/aws_ubuntu/ansible/* deploy-aws-ubuntu-ci/ansible/
cp -R ci_environments/aws_ubuntu/scripts/* deploy-aws-ubuntu-ci/scripts/

# Navigate to directory
cd deploy-aws-ubuntu-ci
